...
System.out.println("ID IS: "+emp_no);
...
pst_budget.setInt(1,emp_no);
rs_budget = pst_budget.executeQuery();
rs_budget.next();
...
<div>
<br>
<form action="user_modify_validate.jsp">
<table>
	<tr>
		<td>Emp No.:</td>
		<td><input type="number" value="<%=emp_no%>" id="emp_no" name="emp_no" readonly></input></td>
	</tr>
	<tr>
		<td>Faculty Name:</td>
		<td><input type="text" value="<%=rs_budget.getString("full_name")%>"></input></td>
	</tr>
	<tr>
		<td>Total Allocated Budget:</td>
		<td><input type="number" id="user_total_budget" name="user_total_budget" value="<%=rs_budget.getFloat("user_total_budget")%>"></input></td>
	</tr>
	<tr>
		<td>Main Budget:</td>
		<td><input type="number" id="user_main_budget" name="user_main_budget" value="<%=rs_budget.getFloat("user_main_budget")%>"></input></td>
	</tr>
	<tr>
		<td>Additional Budget:</td>
		<td><input type="number" id="user_add_budget" name="user_add_budget" value="<%=rs_budget.getFloat("user_add_budget")%>"></input></td>
	</tr>
	<tr>
		<td>Committed Name:</td>
		<td><input type="number" id="user_commit" name="user_commit" value="<%=rs_budget.getFloat("user_commit")%>"></input></td>
	</tr>
	<tr>
		<td>Spent Budget:<br><br></td>
		<td><input type="number" id="user_spent" name="user_spent" value="<%=rs_budget.getFloat("user_spent")%>"></input><br><br></td>
	</tr>
	<tr>
